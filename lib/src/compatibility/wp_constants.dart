...
///
/// This file contains all constants, enums, and helper functions from the original
/// flutter_wordpress library to maintain backward compatibility.
...
enum WordPressAuthenticator { JWT, ApplicationPasswords }
...
enum PostPageStatus { publish, future, draft, pending, private }

enum PostCommentStatus { open, closed }

enum PostPingStatus { open, closed }
...
enum UsersOrderBy { id, include, name, registered_date, slug, email, url }

enum CommentOrderBy { date, date_gmt, id, include, post, parent, type }

enum CommentStatus { all, approve, hold, spam, trash }
...
enum MediaStatus { inherit, publish, future, draft, pending, private }

enum MediaType { image, video, audio, application }
